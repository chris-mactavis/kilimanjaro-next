          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-4 text-center">
                <img className="img-fluid" src="/images/location.jpeg" alt=""/>
